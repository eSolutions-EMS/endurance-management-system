...
public class ProcessSnapshotTests : JudgeIntegrationTest
{
    ...
    [InlineData(SnapshotMethod.RFID)]
    [InlineData(SnapshotMethod.EmsIntegration)]
    public async Task Test3(SnapshotMethod method)
    {
        await Seed();
        var arriveAt = TimestampHelper.Create(19, 30);
        var snapshot = new Snapshot(
    ...
    [InlineData(SnapshotMethod.RFID)]
    [InlineData(SnapshotMethod.EmsIntegration)]
    public async Task Test4(SnapshotMethod method)
    {
        await Seed();
        var presentAt = TimestampHelper.Create(19, 35);
        var snapshot = new Snapshot(
    ...
    [InlineData(SnapshotMethod.RFID)]
    [InlineData(SnapshotMethod.EmsIntegration)]
    public async Task Test5(SnapshotMethod method)
    {
        await Seed();
        var arriveAt = TimestampHelper.Create(19, 30);
        var snapshot = new Snapshot(
    ...
    [InlineData(SnapshotMethod.RFID)]
    [InlineData(SnapshotMethod.EmsIntegration)]
    public async Task Test6(SnapshotMethod method)
    {
        await Seed();
        var presentAt = TimestampHelper.Create(19, 35);
        var snapshot = new Snapshot(
    ...
    [InlineData(SnapshotMethod.RFID)]
    [InlineData(SnapshotMethod.EmsIntegration)]
    public async Task Test7(SnapshotMethod method)
    {
        await Seed();
        var arriveAt = TimestampHelper.Create(19, 30);
        var snapshot = new Snapshot(
    ...
    [InlineData(SnapshotMethod.RFID)]
    [InlineData(SnapshotMethod.EmsIntegration)]
    public async Task Test8(SnapshotMethod method)
    {
        await Seed();
        var presentAt = TimestampHelper.Create(19, 35);
        var snapshot = new Snapshot(
    ...
    [InlineData(SnapshotMethod.RFID)]
    [InlineData(SnapshotMethod.EmsIntegration)]
    public async Task Test9(SnapshotMethod method)
    {
        await Seed();
        var arriveAt = TimestampHelper.Create(19, 30);
        var snapshot = new Snapshot(
    ...
    [InlineData(SnapshotMethod.RFID)]
    [InlineData(SnapshotMethod.EmsIntegration)]
    public async Task Test10(SnapshotMethod method)
    {
        await Seed();
        var presentAt = TimestampHelper.Create(19, 35);
        var snapshot = new Snapshot(
