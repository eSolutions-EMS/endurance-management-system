...
public static class Strings
{
    ...
    public static string CANNOT_ADD_PARTICIPATION_DIFFERENT_PHASE_COUNT_MESSAGE
    {
        get;
        internal set;
    }
    public static string CANNOT_ADD_PARTICIPATION_DIFFERENT_PHASE_LENGTHS_MESSAGE
    {
        get;
        internal set;
    }
