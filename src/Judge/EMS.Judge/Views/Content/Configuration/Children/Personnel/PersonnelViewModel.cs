...
public class PersonnelViewModel
    : NestedConfigurationBase<PersonnelView, Personnelz>,
        IPersonnelState
{
    ...
    public PersonnelViewModel(IExecutor<ConfigurationRoot> executor, IQueries<Personnelz> personnel)
        : base(personnel)
    {
    ...
    {
        var result = this.executor.Execute(config => config.Save(this), true);
        return result;
    }
