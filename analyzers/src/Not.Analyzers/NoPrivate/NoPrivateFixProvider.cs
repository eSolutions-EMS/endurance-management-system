...
namespace NoPrivate
{
    ...
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(NoPrivateAnalyzer.DiagnosticId);
        ...
        private async Task<Document> RemovePrivateKeywordAsync(Document document, MemberDeclarationSyntax declaration, CancellationToken cancellationToken)
        {
